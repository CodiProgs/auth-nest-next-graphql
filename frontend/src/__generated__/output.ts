...
export type LoginMutation = {
	...
	login: {
		__typename?: 'AuthType'
		accessToken: string
		user: { __typename?: 'UserType'; id: string; name: string; email: string }
	}
}
...
export const LoginDocument = gql`
	mutation Login($authInput: LoginDto!) {
		login(loginInput: $authInput) {
			user {
				...userFields
			}
			accessToken
...
export const RegisterDocument = gql`
	mutation Register($authInput: RegisterDto!) {
		register(registerInput: $authInput) {
			user {
				...userFields
			}
			accessToken
